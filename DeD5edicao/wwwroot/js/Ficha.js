window.onload = function carregaAtributos() {
    ...
    document.getElementById("mod_destreza").value = localStorage.getItem("mod-destreza");
    document.getElementById("mod_constituicao").value = localStorage.getItem("mod-constituicao");
    document.getElementById("mod_inteligencia").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("mod_sabedoria").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("mod_carisma").value = localStorage.getItem("mod-carisma");
    document.getElementById("mod_iniciativa").value = localStorage.getItem("mod-destreza");
    document.getElementById("teste-forca").value = localStorage.getItem("mod-forca");
    document.getElementById("teste-destreza").value = localStorage.getItem("mod-destreza");
    document.getElementById("teste-constituicao").value = localStorage.getItem("mod-constituicao");
    document.getElementById("teste-inteligencia").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("teste-sabedoria").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("teste-carisma").value = localStorage.getItem("mod-carisma");
    document.getElementById("pericia-acrobacia").value = localStorage.getItem("mod-destreza");
    document.getElementById("pericia-arcanismo").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("pericia-atletismo").value = localStorage.getItem("mod-forca");
    document.getElementById("pericia-atuacao").value = localStorage.getItem("mod-carisma");
    document.getElementById("pericia-blefar").value = localStorage.getItem("mod-carisma");
    document.getElementById("pericia-furtividade").value = localStorage.getItem("mod-destreza");
    document.getElementById("pericia-historia").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("pericia-intimidacao").value = localStorage.getItem("mod-carisma");
    document.getElementById("pericia-intuica").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("pericia-investigacao").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("pericia-animais").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("pericia-medicina").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("pericia-natureza").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("pericia-percepcao").value = localStorage.getItem("mod-sabedoria");
    document.getElementById("pericia-persuasao").value = localStorage.getItem("mod-carisma");
    document.getElementById("pericia-prestidigitacao").value = localStorage.getItem("mod-destreza");
    document.getElementById("pericia-religiao").value = localStorage.getItem("mod-inteligencia");
    document.getElementById("pericia-sobrevivencia").value = localStorage.getItem("mod-sabedoria");
